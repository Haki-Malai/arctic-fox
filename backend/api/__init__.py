"""
Welcome to ArcticFox's API documentation. If you want to learn more about this project or how to contribute, please visit our
[GitHub repository](https://github.com/Haki-Malai/arctic-fox).
This API is built using [Flask](https://flask.palletsprojects.com/) web framework,
 ...
 This API is also uses:
  ...
  an extension for Flask that adds support for [SQLAlchemy](https://www.sqlalchemy.org/),
  - [Flask-Marshmallow](https://flask-marshmallow.readthedocs.io/en/latest/),
  a thin integration layer for [Marshmallow](https://marshmallow.readthedocs.io/en/stable/),
  - [Flask-HTTPAuth](https://flask-httpauth.readthedocs.io/en/latest/),
  a Flask extension that simplifies the use of HTTP authentication with Flask routes and
  - [APIFairy](https://apifairy.readthedocs.io/en/latest/),
  a minimalistic API framework that uses Marshmallow schemas to generate API documentation.
And others like [Flask-Mail](https://pythonhosted.org/Flask-Mail/),
